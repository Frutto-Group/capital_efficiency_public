...
class Initializer():
    def __init__(self, constant: float, k: float, random_k: str = "False"):
        """
        ...
        3. random_k: whether or not to use random k for each pool
        """
    ...
    def get_stats(self
        ...
        return self.pairwise_pools, self.pairwise_infos, self.single_pools, \
            self.single_infos, self.traffic_info, self.price_gen_info, self.crash_types